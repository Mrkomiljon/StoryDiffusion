...
def add_caption(image, text, position="bottom-mid", font=None, text_color='black', bg_color=(255, 255, 255), bg_opacity=200):
    ...
    for ind, line in enumerate(lines[::-1]):
        bbox = draw.textbbox((0, 0), line, font=font)  # Get the bounding box of the text
        text_width = bbox[2] - bbox[0]  # Extract the width from the bounding box
        text_height = bbox[3] - bbox[1]  # Extract the height from the bounding box
